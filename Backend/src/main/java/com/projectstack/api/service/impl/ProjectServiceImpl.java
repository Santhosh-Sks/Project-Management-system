...
public class ProjectServiceImpl implements ProjectService {
    ...
    public boolean deleteProject(String projectId, String userId) {
        ...
        Optional<Project> projectOptional = projectRepository.findById(objectId.toString());
        ...
        if (projectOptional.isPresent()) {
            ...
            boolean isAdmin = project.getMembers().stream()
                    .anyMatch(member -> member.getId().equals(userId) && "admin".equals(member.getRole()));
            ...
            if (isAdmin) {
                ...
                System.out.println("❌ User is not authorized to delete this project.");
            }
        } else {
