...
import com.projectstack.api.payload.request.LogoutRequest;
...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
        try {
            ...
            JwtResponse response = new JwtResponse(
                ...
                null, null, null, registeredUser.getRoles()
            );
    ...
    @PostMapping("/logout")
    public ResponseEntity<MessageResponse> logout(@RequestHeader("Authorization") String token, @RequestBody LogoutRequest logoutRequest) {
    ...
    public ResponseEntity<OTPResponse> verifyOtp(@RequestBody OTPRequest otpRequest) {
        boolean isValid = otpService.validateOTP(otpRequest.getOtp(), otpRequest.getEmail());
        if (isValid) {
