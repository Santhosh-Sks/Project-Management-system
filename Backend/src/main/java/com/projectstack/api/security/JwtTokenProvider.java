...
public class JwtTokenProvider {
    ...
    public String generateRefreshToken(String userId, String username, String email) {
        ...
        Date now = new Date();
        Date refreshTokenExpiryDate = new Date(now.getTime() + (jwtExpiration * 2));  // A longer expiration time

        logger.debug("Generating refresh token for user: {}, expires at: {}", username, refreshTokenExpiryDate);
    ...
    // Removed unused method isTokenExpired as it was not being used locally
}